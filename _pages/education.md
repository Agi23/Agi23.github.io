  ...
  <div class="edu-content">
    ...
    <div class="project-row">
      <div class="project-text">
        ...
        <ul>
          <li>Designed API functionality</li>
          <li>Hardware/software integration</li>
          <li>Documentation and testing workflows</li>
        </ul>

        <p>
          <a href="https://github.com/IanEdwards99/nfcreader">View the Github repo</a>
        </p>
      </div>
      ...
      <div class="project-media">
        <div class="generic-carousel single-media">
          ...
          <div class="media-caption">
            <p>Demonstration of the CR95HF NFC API running on Raspberry Pi.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="edu-entry">
  <div class="edu-logo">
    <img src="/assets/img/dsg.jpg" alt="dsg image">
  </div>
  <div class="edu-content">
    <h2>IEB National Senior Certificate</h2>
    <p><strong>St Mary's DSG Pretoria</strong><br><em>2013–2017</em></p>

    <p><strong>Achievements</strong><br></p>
    <ul>
      <li>7 distinctions in the IEB National Senior Certificate</li>
      <li>Information Technology subject prize winner</li>
    </ul>

    <p><a href="/assets/pdf/certificate.pdf">Download certificate</a></p>
  </div>
</div>
